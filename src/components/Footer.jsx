...
export default function Footer() {
  return (
    <div className='flex flex-col justify-center items-center card-footer m-1 p-1 text-sm hover:text-blue-600 hover:font-semibold transition duration-400 ease-in-out'>
        <span>
